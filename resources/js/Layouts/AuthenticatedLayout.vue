        ...
        <aside :class="[
            ...
            <nav class="flex-1 overflow-y-auto py-4 space-y-6">
                ...
                <div>
                    ...
                    <SidebarLink :href="route('billings.monitoring')" :active="route().current('billings.monitoring')" :icon="`<svg fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'></path></svg>`">
                        Monitoring Tagihan
                    </SidebarLink>
                    <SidebarLink :href="route('reports.classrooms')" :active="route().current('reports.classroom*')" :icon="`<svg fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z'></path></svg>`">
                        Laporan per Kelas
                    </SidebarLink>
                    <SidebarLink :href="route('reports.majors')" :active="route().current('reports.major*')" :icon="`<svg fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z'></path></svg>`">
                        Laporan per Jurusan
                    </SidebarLink>
                    <SidebarLink :href="route('reports.bku.index')" :active="route().current('reports.bku.*')" :icon="`<svg fill='none' stroke='currentColor' viewBox='0 0 24 24'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.754 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'></path></svg>`">
                        Buku Kas Umum (BKU)
                    </SidebarLink>
                </div>
                ...
                <div>
                    ...
                    <SidebarLink :href="route('expense-categories.index')" :active="route().current('expense-categories.*')" :icon="icons.kategori">
                        Kategori Pengeluaran
                    </SidebarLink>
                </div>
                <!-- Pengaturan Section -->
                <div>
                    <div class="px-5 text-[11px] font-bold text-blue-300/70 uppercase tracking-widest mb-2 mt-2">Pengaturan & Sistem</div>
            ...
            <!-- Sidebar Footer -->
            <div class="p-4 border-t border-white/10 text-xs font-medium text-blue-200/50 text-center">
                &copy; {{ new Date().getFullYear() }} SIMAKU
            </div>
        </aside>
                    ...
                    <Dropdown align="right" width="48">
                        <template #trigger>
                            <button type="button" class="flex items-center gap-2 bg-gray-50 hover:bg-gray-100 border border-gray-200 px-2 sm:px-3 py-1.5 rounded-xl transition-colors focus:outline-none">
                                <div class="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-r from-[#1a237e] to-[#0d47a1] flex items-center justify-center text-white shadow-sm">
                        ...
                        <template #content>
                            <div class="px-4 py-3 border-b border-gray-100">
                                ...
                                <p class="text-sm font-bold text-[#1a237e] truncate">{{ $page.props.auth.user.email }}</p>
                            </div>
                            <DropdownLink :href="route('profile.edit')" class="font-medium text-sm text-gray-700 hover:text-[#1a237e] hover:bg-indigo-50">
                                Pengaturan Profil
                            </DropdownLink>

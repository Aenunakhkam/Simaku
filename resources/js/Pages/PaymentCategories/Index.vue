                        ...
                        <table class="w-full text-sm text-left text-gray-500">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 border-b border-gray-200">
                                <tr>
                                    ...
                                    <th class="px-6 py-4 font-semibold text-right">Nominal Default</th>
                            ...
                            <tbody>
                                ...
                                <tr v-if="categories.data.length === 0">
                                    <td colspan="4" class="px-6 py-8 text-center text-gray-500 bg-gray-50/50">Belum ada data kategori pemasukan.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <Modal :show="isCreateModalOpen || isEditModalOpen" @close="closeModals">
            <div class="p-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-5">
                    {{ isEditModalOpen ? 'Edit Kategori Pemasukan' : 'Tambah Kategori Pemasukan' }}
                </h2>
